...
export default {
    ...
    add: function (core, targetElement) {
        ...
        contextTable.gridButton = tableController.querySelector('._se_table_grid');
        ...
        tableResize.innerHTML = '' +
            '<div>' +
                '<div class="se-btn-group">' +
                    ...
                    '</button>' +
                    '<button type="button" data-command="grid" class="se-btn se-tooltip _se_table_grid">' +
                        '<i class="fas fa-border-none"></i>' +
                        '<span class="se-tooltip-inner"><span class="se-tooltip-text">' + this.grid_tooltip + '</span></span>' +
                    '</button>' +
    ...
    reset_table_picker: function () {
        ...
        this.submenuOff();
        document.querySelector('.se-submenu.se-selector-table').style.display = 'none';
    },
    init: function () {
    ...
    call_controller_tableEdit: function (tdElement) {
        ...
        contextTable._grid = this.util.hasClass(tableElement, 'se-table-grid');
    ...
    setTableStyle: function (styles) {
        ...
        if (styles.indexOf('width') > -1) {
            ...
            if (!contextTable._maxWidth) {
                ...
                contextTable.gridButton.style.display = 'none';
                ...
                contextTable.gridButton.style.display = 'block';
        ...
        if (styles.indexOf('column') > -1) {
            ...
            if (!contextTable._grid) {
                this.util.removeClass(tableElement, 'se-table-grid');
                this.util.removeClass(contextTable.gridButton, 'active');
            } else {
                this.util.addClass(tableElement, 'se-table-grid');
                this.util.addClass(contextTable.gridButton, 'active');
            }
    ...
    onClick_tableController: function (e) {
        ...
        switch (command) {
            ...
            case 'layout':
                ...
                break;
            case 'grid':
                contextTable._grid = !contextTable._grid;
                contextTable._fixedColumn = contextTable._grid;
                tablePlugin.setTableStyle.call(this, 'column');
                tablePlugin.setPositionControllerTop.call(this, contextTable._element);
                tablePlugin.setPositionControllerDiv.call(this, contextTable._tdElement, tablePlugin._shift);
                break;
