<script lang="ts">
  ...
  pagePath.set(
    `&gt; <a href="/components/field">Components</a> &gt; <a href="/components/button">Button</a>`
  );
</script>
...
<h2>Click Event & Status</h2>
<p>If the Status is 'is-static' or 'is-loading' or 'disabled', the Click event will not work.</p>
<Button
  class="is-primary"
  on:click={() => {
    alert('click!');
