<script>
  ...
  <Layout {pageTitle} {pagePath}>
	...
	<p>
	  <a href="https://kit.svelte.dev/docs/routing" target="_blank" rel="noreferrer">Sveltekit Documentation</a>
	</p>
	...
	<p>
	  ...
	  <a
		...
		target="_blank" rel="noreferrer">FA free Cheatsheet</a
	  >
	</p>
	...
	<table class="table is-fullwidth  is-hoverable">
	  ...
	  <tbody>
		...
		<tr>
		  <td>Bulma</td>
		  <td
			><a href="https://bulma.io/" target="_blank" rel="noreferrer">https://bulma.io/</a></td
		  >
		  <td>MIT</td>
		</tr>
		<tr>
		  <td>Pretendard</td>
		  <td
			><a href="https://cactus.tistory.com/306" target="_blank"
			rel="noreferrer">https://cactus.tistory.com/306</a
			></td
		  >
		  <td>OFL</td>
		</tr>
		...
		<tr>
		  <td>SunEditor</td>
		  <td
			><a href="http://suneditor.com/" target="_blank" rel="noreferrer"
