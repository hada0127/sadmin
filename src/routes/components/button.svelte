<script>
  ...
  let pagePath = `&gt; <a href="/components/field">Components</a> &gt; <a href="/components/button">Button</a>`;
</script>
...
<Layout {pageTitle} {pagePath}>
  ...
  <p>
    If the Status is 'is-static' or 'is-loading' or 'disabled', the Click event
    will not work.
  </p>
  <Button
    class="is-primary"
